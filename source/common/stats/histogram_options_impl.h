...
public:
  HistogramOptionsImpl()
      : supported_buckets_(defaultBuckets()), supported_quantiles_(defaultQuantiles()){};
   ...
   * @param buckets vector of buckets which are used to extract sample counts for the provided
   * histogram
